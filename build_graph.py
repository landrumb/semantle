...
if graph_type == "pynndescent":
    ...
    wp.build_vamana_index("Euclidian", "float", data_dir / "base.fbin", data_dir / "outputs" / "vamana", 40, 100, 1.2, False)
...
Index = wp.load_index("Euclidian", "float", data_dir / "base.fbin", data_dir / "outputs" / graph_type)

neighbors, distances = Index.batch_search_from_string(str(data_dir / "query.fbin"), 10, 10, True, 10000)
